  ...
  return (
    <div className="min-h-screen px-4 py-6 md:px-8 md:py-8">
      <div className="mx-auto flex max-w-[1500px] flex-col gap-4">
        <header className="animate-fade-up rounded-2xl border border-slate-200 bg-white/90 p-5 shadow-panel">
        ...
        <main className="grid min-h-[calc(100vh-220px)] gap-4 xl:grid-cols-[1fr_360px]">
          <WorkflowCanvas />
          <div className="flex max-h-[calc(100vh-240px)] flex-col gap-4 overflow-y-auto pr-1">
            <NodeFormPanel />
            <SimulatePanel />
          </div>
        </main>
